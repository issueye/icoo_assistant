...
func (a *app) writeFakeModeNoOutputHint(out io.Writer) {
	...
	_, _ = fmt.Fprintln(out, "hint: this is expected in fake mode; set anthropic.api_key in config.toml for real answers, or keep following the minimal_happy_path as a local dry run.")
}
