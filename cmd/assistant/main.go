...
func printUsage(out io.Writer) {
	...
	_, _ = fmt.Fprintln(out, "  Load settings from config.toml in the current working directory.")
	_, _ = fmt.Fprintln(out, "  See config.toml.example for supported settings.")
