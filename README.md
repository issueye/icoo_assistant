...
当前仓库已经在 `0.1.30` 初代可用版基线上完成 `0.1.31` 与 `0.1.32` 两轮 post-release hardening，能力范围包括：
...
`0.1.32` 的定位仍然不是“功能很多”，而是“新用户按 README、--help 和 assistant check 可以完成一条一致、可直接执行的最小闭环”。当前版本更适合：
